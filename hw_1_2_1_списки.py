# -*- coding: utf-8 -*-
"""hw_1.2.1 Списки.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1BanwnE5Psp0PPhCYa9lxHDZGQHixNbvs
...
print('Max element - ' + str(max(my_list)))
print('Min element - ' + str(min(my_list)))
